    ...
    return (
        <div className='flex cover justify-center items-center bg-gray-100 min-h-screen min-w-full'>
            ...
            <div className='lg:hidden'>
                <div className='text-6xl text-yellow-900 font-medium'>Reposteria Fina</div>
                <div className='text-3xl text-yellow-600 font-semibold'>Los mejores pasteles de CDMX</div>
                <button className='bg-opacity-25 bg-white text-xl border border-yellow-900 rounded px-4 py-2 mt-5 font-semibold text-yellow-900'>
                    Hacer Pedido
                </button>
            </div>
        </div>
