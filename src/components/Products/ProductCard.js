    ...
    return (
        ...
        <div className='grid grid-cols-2 bg-white shadow my-3'>
            ...
            <div className='col-span-1 p-5'>
                <div className='text-right text-2xl font-semibold'><AiOutlineDoubleLeft className='mr-0 ml-auto text-yellow-800'/></div>
                <h5 className='my-4 text-4xl font-bold text-yellow-900' >TARTA DE ALMENDRA</h5>
                <div className='flex flex-wrap content-center'>
                    <div className='px-12 text-left'>
                        ...
                        <button className='rounded bg-yellow-800 text-gray-100 font-semibold  px-5 py-2 px-4  mt-8 focus:outline-none mr-0 ml-auto'>
                                HACER PEDIDO
                        </button>
                    </div>
                </div>
        ...
        <div className='grid grid-cols-2 bg-white shadow my-3'>
            <div className='col-span-1 p-5'>
                <div className='text-left text-2xl font-bold'><AiOutlineDoubleRight className='mr-auto ml-0 text-yellow-800'/></div>
                <h5 className='my-4 text-4xl font-bold text-yellow-900' >PASTEL MIL HOJAS</h5>
                <div className='flex flex-wrap content-center'>
                    <div className='px-12 text-left'>
                        ...
                        <button className='rounded bg-yellow-800 text-gray-100 font-semibold  px-5 py-2 px-4  mt-8 focus:outline-none'>
                                HACER PEDIDO
                        </button>
                    </div>
                </div>
        ...
        <div className='grid grid-cols-2 bg-white shadow my-3'>
            ...
            <div className='col-span-1 p-5'>
                <div className='text-right text-2xl font-bold'><AiOutlineDoubleLeft className='mr-0 ml-auto text-yellow-800'/></div>
                <h5 className='my-4 text-4xl font-bold text-yellow-900' >PASTEL DE ZANAHORIA</h5>
                <div className='flex flex-wrap content-center'>
                    <div className='px-12 text-left'>
        ...
        <div className='grid grid-cols-2 bg-white shadow my-3'>
            <div className='col-span-1 p-5'>
                <div className='text-left text-2xl font-bold'><AiOutlineDoubleRight className='mr-auto ml-0 text-yellow-800'/></div>
                <h5 className='my-4 text-4xl font-bold text-yellow-900' >CRÊPE CAKE DE CONEJITO TURÍN</h5>
                <div className='flex flex-wrap content-center'>
                    <div className='px-12 text-left'>
        ...
        <div className='grid grid-cols-2 bg-white shadow my-3'>
            ...
            <div className='col-span-1 p-5'>
                <div className='text-right text-2xl font-extrabold'><AiOutlineDoubleLeft className='mr-0 ml-auto text-yellow-800'/></div>
                <h5 className='my-4 text-4xl font-bold text-yellow-900' >FUDGE DE CHOCOLATE</h5>
                <div className='flex flex-wrap content-center'>
                    <div className='px-12 text-left'>
        ...
        <div className='grid grid-cols-2 bg-white shadow my-3'>
            <div className='col-span-1 p-5'>
                <div className='text-left text-2xl font-extrabold text-yellow-800'><AiOutlineDoubleRight className='mr-auto ml-0 text-yellow-800'/></div>
                <h5 className='my-4 text-4xl font-bold text-yellow-900' >PASTEL DE QUESO TIPO ESPAÑOL</h5>
                <div className='flex flex-wrap content-center'>
                    <div className='px-12 text-left'>
